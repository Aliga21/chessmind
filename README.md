...
**在线体验**：[https://chessmind-mocha.vercel.app/](https://chessmind-mocha.vercel.app/)
...
- **Stockfish 18 NNUE 引擎** — 神经网络评估，浏览器 WebAssembly 本地运行
- **智能着法分类** — 最佳 / 优秀 / 良好 / 失误 / 错误 / 大错，彩色标注
- **多线候选分析** — 同时展示多条候选着法及评估分数
- **六维能力画像** — 开局 / 中局 / 残局 / 战术 / 质量 / 稳定性，雷达图可视化
- **AI 中文解说** — 大语言模型驱动，关键着法深度解读与训练建议
- **隐私保护** — 100% 本地运行，棋谱不上传服务器
...
│   ├── engine.js                 # UCI 引擎封装
│   ├── board.js                  # 棋盘渲染与交互
│   ├── lichess.js               # Lichess API 接入
│   ├── vendor/
│   │   ├── chess.min.js          # chess.js 棋规库
│   │   ├── stockfish-18-lite-single.js   # SF18 NNUE 引擎 JS
│   │   └── stockfish-18-lite-single.wasm # SF18 NNUE WASM 二进制
│   └── piece/cburnett/           # cburnett 棋子 SVG
